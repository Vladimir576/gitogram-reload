<template>
  <div class="topline-part">

      <h1 class="topline-part__title" :class="titleColor" >Gitogram /</h1>
   
  </div>
  <div class="topline-part">
    <slot name="topline-part__icons-slot">
      <div class="topline-part__icons topline-part__icons-owner">
        <svg
          width="24"
          height="26"
          viewBox="0 0 24 26"
      ...
      <div class="topline-part__icons">
        <img src="../../assets/icons/OwnerAVa.png" alt="" />
      </div>
      <div class="topline-part__icons">
        <svg
          width="26"
...
export default {
  ...
  // data(){
  //   return {
  //     titleColor: "topline-part__title--color",
  //   }
  // },
  props: {
      titleColor: {
